    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        email_input.addTextChangedListener(object : TextWatcher {
            override fun afterTextChanged(s: Editable?) {
                if (validEmail) {
                    email_input.background = activity?.getDrawable(R.drawable.rounded_button_valid)
                }
                else {
                    email_input.background = activity?.getDrawable(R.drawable.rounded_button_invalid)
                }
            }

            override fun beforeTextChanged(s: CharSequence?, start: Int, count: Int, after: Int) {
                email_input.background = activity?.getDrawable(R.drawable.rounded_button_background)
            }
